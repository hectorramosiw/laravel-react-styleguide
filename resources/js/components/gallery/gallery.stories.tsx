...
const MOCK_IMAGES: GalleryItemData[] = [
  ...
  },
  {
    ...
    title: "Sunlit Forest",
    category: "nature",
    description: "Sunlight filtering through the canopy of a temperate rainforest.",
  },
  {
    id: 3,
    ...
    description: "A futuristic view of a modern metropolitan business district.",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    title: "Parisian Arch",
    category: "architecture",
    description: "The iconic Arc de Triomphe captured during the golden hour.",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    title: "Coastal Bliss",
    category: "travel",
    description: "Crystal clear waters meeting the rugged cliffs of the Amalfi Coast.",
  },
  {
    id: 8,
    ...
    category: "travel",
    description: "A hiker reaching the summit after a long day of climbing.",
  },
];
